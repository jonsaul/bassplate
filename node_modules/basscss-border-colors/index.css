...
.border-darken-5 { border-color: var(--darken-5) }
.border-darken-6 { border-color: var(--darken-6) }
.border-darken-7 { border-color: var(--darken-7) }
.border-darken-8 { border-color: var(--darken-8) }

.border-lighten-1 { border-color: var(--lighten-1) }
.border-lighten-2 { border-color: var(--lighten-2) }
.border-lighten-3 { border-color: var(--lighten-3) }
.border-lighten-4 { border-color: var(--lighten-4) }
.border-lighten-5 { border-color: var(--lighten-1) }
.border-lighten-6 { border-color: var(--lighten-2) }
.border-lighten-7 { border-color: var(--lighten-3) }
.border-lighten-8 { border-color: var(--lighten-4) }
