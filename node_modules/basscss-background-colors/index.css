...
.bg-darken-5 { background-color: var(--darken-5) }
.bg-darken-6 { background-color: var(--darken-6) }
.bg-darken-7 { background-color: var(--darken-7) }
.bg-darken-8 { background-color: var(--darken-8) }
...
.bg-lighten-5 { background-color: var(--lighten-5) }
.bg-lighten-6 { background-color: var(--lighten-6) }
.bg-lighten-7 { background-color: var(--lighten-7) }
.bg-lighten-8 { background-color: var(--lighten-8) }
