...
.field.is-focused {
  ...
  box-shadow: 0 0 0 1px color(var(--field-focus-color) a(.5));
}
...
.field.is-success.is-focused {
  box-shadow: 0 0 0 1px color(var(--field-success-color) a(.5));
}
...
.field.is-warning.is-focused {
  box-shadow: 0 0 0 1px color(var(--field-warning-color) a(.5));
}
...
.field.is-error.is-focused {
  box-shadow: 0 0 0 1px color(var(--field-error-color) a(.5));
}
